...
`;
const chatButtonHtml = `<div class="maxkb-chat-button" ><svg style="vertical-align: middle;overflow: hidden;" width="48" height="56" viewBox="0 0 48 56" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const getChatContainerHtml = (protocol, host, token) => {
	// http://10.25.231.163:9000/AiChat?accessToken=3 src=${protocol}://${host}/ui/chat/${token}?mode=embed
	return `<div id="maxkb-chat-container">
<iframe id="maxkb-chat" src= http://10.25.231.163:9000/AiChat?accessToken=3></iframe>
